...
from models.cnn_fast import CNN
...
if __name__ == '__main__':
    ...
    if (not arguments.has_key('train_data')) or (not arguments.has_key('valid_data')) or (not arguments.has_key('conv_nnet_spec')) or (not arguments.has_key('full_nnet_spec')) or (not arguments.has_key('wdir')) or (not arguments.has_key('conv_output_file')) or (not arguments.has_key('full_output_file')):
    ...
    if arguments.has_key('ptr_file'):
        print "Warn: pre-training of CNNs is NOT supported for now"
